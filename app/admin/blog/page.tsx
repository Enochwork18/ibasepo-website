...
export default function BlogManager() {
  ...
  const { addActivityLog, deleteBlog } = useAdminStore()
                  ...
                  filteredPosts.map((post) => (
                    <tr key={post.id} className="hover:bg-accent/50">
                      <td className="px-6 py-4">
                        ...
                        <p className="text-xs text-muted-foreground">{post.excerpt?.substring(0, 50)}...</p>
                      </td>
                      <td className="px-6 py-4 text-sm text-muted-foreground">{post.author}</td>
                      <td className="px-6 py-4 text-sm text-muted-foreground">{post.category}</td>
